...
import type { AP_IconName, CareerFormLabels, CareerStat, CareerStep, Locale } from "@/shared/types";
...
export default async function AP_CareersSections({ embedded = false, locale = "en" }: { embedded?: boolean; locale?: Locale }) {
