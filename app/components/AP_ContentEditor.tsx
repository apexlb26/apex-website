...
function renderSiteSection(section: SiteSection, content: SiteContent, change: (path: string, value: unknown) => void, value: (path: string) => string) {
  ...
  if (section === "solutions") {
    return <><SectionHead eyebrow="HOMEPAGE" title="Solutions" description={sectionDescriptions.solutions} /><div className="editor-card-body"><div className="field-grid"><TextField label="Eyebrow" value={value("solutions.eyebrow")} onChange={(v) => change("solutions.eyebrow", v)} /><TextField label="Section title" value={value("solutions.title")} onChange={(v) => change("solutions.title", v)} /><div className="field full"><TextArea label="Body" value={value("solutions.body")} onChange={(v) => change("solutions.body", v)} /></div><TextField label="Card CTA" value={value("solutions.cta")} onChange={(v) => change("solutions.cta", v)} /></div><div className="form-divider" /><div className="array-stack">{content.solutions.items.map((item, index) => <div className="subcard" key={item.key}><div className="subcard-head"><strong>{item.number} · {item.title}</strong><span>{item.key}</span></div><div className="field-grid"><TextField label="Title" value={item.title} onChange={(v) => change(`solutions.items.${index}.title`, v)} /><TextArea label="Body" value={item.body} onChange={(v) => change(`solutions.items.${index}.body`, v)} /></div></div>)}</div><div className="form-divider" /><SectionHead eyebrow="SOLUTIONS" title="Capability dialog" description="Everything the “Explore capability” dialog shows for each solution." /><div className="field-grid"><TextField label="Explore link label" value={value("solutions.exploreLabel")} onChange={(v) => change("solutions.exploreLabel", v)} /><TextField label="“What it includes” heading" value={value("solutions.detailIncludesLabel")} onChange={(v) => change("solutions.detailIncludesLabel", v)} /><TextField label="“Use cases” heading" value={value("solutions.detailUseCasesLabel")} onChange={(v) => change("solutions.detailUseCasesLabel", v)} /><TextField label="“Outcomes” heading" value={value("solutions.detailOutcomesLabel")} onChange={(v) => change("solutions.detailOutcomesLabel", v)} /><TextField label="Primary button" value={value("solutions.detailPrimaryCta")} onChange={(v) => change("solutions.detailPrimaryCta", v)} /><TextField label="Secondary button" value={value("solutions.detailSecondaryCta")} onChange={(v) => change("solutions.detailSecondaryCta", v)} /></div><div className="array-stack">{Object.entries(content.solutions.details ?? {}).map(([key, detail]) => <div className="subcard" key={`detail-${key}`}><div className="subcard-head"><strong>{detail.title}</strong><span>{key}</span></div><div className="field-grid"><TextField label="Dialog title" value={detail.title} onChange={(v) => change(`solutions.details.${key}.title`, v)} /><TextField label="Icon" value={detail.icon} onChange={(v) => change(`solutions.details.${key}.icon`, v)} /><div className="field full"><TextArea label="Intro" value={detail.intro} onChange={(v) => change(`solutions.details.${key}.intro`, v)} /></div><div className="field full"><TextField label="What it includes (separate with |)" value={detail.includes.join(" | ")} onChange={(v) => change(`solutions.details.${key}.includes`, v.split("|").map((x) => x.trim()).filter(Boolean))} /></div></div><div className="array-stack">{detail.useCases.map((useCase, i) => <div className="subcard" key={`uc-${key}-${i}`}><div className="subcard-head"><strong>Use case {i + 1}</strong><span>{useCase.icon}</span></div><div className="field-grid"><TextField label="Title" value={useCase.title} onChange={(v) => change(`solutions.details.${key}.useCases.${i}.title`, v)} /><TextField label="Icon" value={useCase.icon} onChange={(v) => change(`solutions.details.${key}.useCases.${i}.icon`, v)} /><div className="field full"><TextArea label="Body" value={useCase.body} onChange={(v) => change(`solutions.details.${key}.useCases.${i}.body`, v)} /></div></div></div>)}</div><div className="array-stack">{detail.outcomes.map((outcome, i) => <div className="subcard" key={`oc-${key}-${i}`}><div className="subcard-head"><strong>Outcome {i + 1}</strong><span>{outcome.value}</span></div><div className="field-grid"><TextField label="Value" value={outcome.value} onChange={(v) => change(`solutions.details.${key}.outcomes.${i}.value`, v)} /><TextField label="Icon" value={outcome.icon} onChange={(v) => change(`solutions.details.${key}.outcomes.${i}.icon`, v)} /><TextField label="Title" value={outcome.title} onChange={(v) => change(`solutions.details.${key}.outcomes.${i}.title`, v)} /><div className="field full"><TextArea label="Body" value={outcome.body} onChange={(v) => change(`solutions.details.${key}.outcomes.${i}.body`, v)} /></div></div></div>)}</div></div>)}</div></div></>;
  }
